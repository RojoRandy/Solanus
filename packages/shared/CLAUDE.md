...
- [src/roles.ts](src/roles.ts), [src/permisos.ts](src/permisos.ts), [src/auth.ts](src/auth.ts), [src/agenda.ts](src/agenda.ts), exportados desde [src/index.ts](src/index.ts).
